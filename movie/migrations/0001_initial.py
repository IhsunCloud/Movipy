    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.CharField(max_length=32, null=True, verbose_name='Family')),
                ('role', models.CharField(choices=[('A', 'Actor'), ('D', 'Director')], max_length=1, null=True, verbose_name='Role')),
                ('birthday', models.DateField(null=True, verbose_name='Birthday')),
                ('image', models.ImageField(null=True, upload_to=movie.submodels.actor.actor_poster_directory_path, verbose_name='Image')),
            ],
        ),
        migrations.CreateModel(
            name='Crew',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('actors', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actor', to='movie.actor')),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('genres', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='genres', to='movie.genre')),
            ],
            options={
                'verbose_name': 'Movie',
        ...
        migrations.AddField(
            model_name='movie',
            name='posters',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='movie.poster'),
        ),
        migrations.AddField(
            model_name='movie',
            name='reviews',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='movie.review', verbose_name='Reviews'),
        ),
        migrations.AddField(
            model_name='movie',
            name='role',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='role', to='movie.role'),
        ),
        migrations.AddField(
            model_name='movie',
            name='tags',
        ...
        migrations.AddField(
            model_name='genre',
            name='movie',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='genre', to='movie.movie'),
        ),
        migrations.AddField(
            model_name='actor',
            name='movie',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actor', to='movie.movie'),
        ),
    ]
